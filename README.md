...
# Sales Analytics Project — PySpark on Databricks
## Overview
...
- menu.csv – Contains item details such as product name and category

- sales.csv – Contains transaction records for sales

Note: CSV files are not stored in the repository. You can upload them in Databricks using the “Create and modify table” option.
